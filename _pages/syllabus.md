...
info:
  ...
  teamshelproom: "https://teams.microsoft.com/l/team/19%3A-VHyn6O2G6VnIfcM9tVFRxJvPDXTW8BJ0Dwgw4te7Hw1%40thread.tacv2/conversations?groupId=bddc5e35-58b6-44ec-a9a0-963c03f26de2&tenantId=921f1c03-8689-4e60-a722-f5ea581e00fe"
  ...
  banner: |
    ...
    <div style="width: 100%; display: table-row;">
        <div style="display: table-cell; padding:5px; width:33%;">
            <a title="Maxtremus, CC0, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Round-robin_schedule_quantum_3.png"><img width="100%" alt="Round-robin schedule quantum 3" src="https://commons.wikimedia.org/w/index.php?title=Special:Redirect/file/Round-robin_schedule_quantum_3.png"></a>
        </div>
        <div style="display: table-cell; padding:5px; width:33%;">
            <a title="Huihermit, CC0, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:MINIX_3.2_Top_Command.png"><img width="100%" alt="MINIX 3.2 Top Command" src="https://commons.wikimedia.org/w/index.php?title=Special:Redirect/file/MINIX_3.2_Top_Command.png"></a>
        </div>
        <div style="display: table-cell; padding:5px; width:33%;">
            <a title="Traced by User:Stannered, original by en:User:Dysprosia, BSD &lt;http://opensource.org/licenses/bsd-license.php&gt;, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Virtual_address_space_and_physical_address_space_relationship.svg"><img width="100%" alt="Virtual address space and physical address space relationship" src="https://commons.wikimedia.org/w/index.php?title=Special:Redirect/file/Virtual_address_space_and_physical_address_space_relationship.svg"></a>
        </div>
    </div>
    </div>
...
- title: "Computer Systems: A Programmer's Perspective"
  authors: "Randal Bryant and David O'Hallaron"
  edition: "3rd Edition"
  isbn: "9780134092669"
...
- title: "Principles of Concurrent and Distributed Programming"
  ...
  edition: "2nd Edition"
  isbn: "0321312839"
  link: https://www.amazon.com/Principles-Concurrent-Distributed-Programming-2nd/dp/032131283X
  isrequired: false 
  freelyavailable: false    
